        ...
        <div class="slide-item last-slide">
            ...
            <div class="auto-container">
                <div class="content-box last-slide-content">
                    ...
                    <p class="slider-text slider-content">Anthing more information on slider three is kept here</p>
                    <div class="btn-box">
            ...
            <div class="row clearfix">
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="banner-carousel owl-theme owl-carousel owl-dots-none owl-autoplay-true owl-loop-true">
                        ...
                        <div class="custom-slide-item">
                            <div class="image-layer" style="background-image: url({{asset('frontenda/images/gallery/project-17.jpg')}})">
    ...
    <section class="news-section bg-color-1">
        <div class="auto-container">
            <div class="sec-title centred">
                ...
                <h2>Blog</h2>
                <div class="sec-text">
                    <p class="blog-text">Belis nisl adipiscing sapien sed malesu diame lacus eget erat Cras mollis scelerisqu Nullam arcu liquam here was consequat.</p>
                </div>
                </div>
            <div class="row clearfix">
