...
<div class="uni-container">
    <div class="news-block-one inner-uni">
        ...
        <div class="rounded inner-div">
            <figure class="image-box"><a href="{{route('college-detail',Crypt::encrypt($university->id))}}"><img src="{{asset('frontend/images/University/manavrachna.png')}}" alt="" class="uni-image"></a></figure>
            <div class="lower-content uni-lower-content">
                <ul class="post-info">
                    {{-- <li>ESTD. 1997</li> --}}
                </ul>
                <h3 class="uni-title-main"><a href="{{route('college-detail', Crypt::encrypt($university->id))}}"  class="uni--title">Manav Rachna International Institute of Research And Studies</a></h3>
                ...
                <div class="link view-course"><a href="{{route('college-detail', Crypt::encrypt($university->id))}}"><i class="fas fa-arrow-right uni-icon"></i><span>View all Courses and Fees</span></a></div>
            </div>
        </div>
    </div>
</div>
